...
def frost(x, severity=1):
    ...
    filename = [
        f"resource/frost1.png",
        f"resource/frost2.png",  # f"{resource_path}/frost2.png",
        f"resource/frost3.png",
        f"resource/frost4.jpg",
        f"resource/frost5.jpg",
        f"resource/frost6.jpg",
    ][idx]
